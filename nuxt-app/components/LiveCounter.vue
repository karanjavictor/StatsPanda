...
const data = ref<CounterItem[]>([
    {
        ...
        value: {
            ...
            'Births this year': {value: 0, onChange: 4.44},
            'Births today': {value: 0, onChange: 0.012},
        }
    },
    {
        label: 'Health', 
        value: {
            'Diseases death this year': {value: 0, onChange: 0.031},
            'Seasonal flu death this year': {value: 0, onChange: 0.00095},
            'Healthcare cases this year': {value: 0, onChange: 0.063},
        }
    },
    {
        label: 'Government & Politics',
        value: {
            'Healthcare Expenditure': {value: 0, onChange: 317.1},
            'Education Expenditure': {value: 0, onChange: 158.5},
            'Military Expenditure': {value: 0, onChange: 63.4},
        }
    },
    {
        label: 'Energy',
        value: {
            'Energy used today (MWh)': {value: 0, onChange: 160.2},
            'Non-renewable energy used today (MWh)': {value: 0, onChange: 106.8},
            'Renewable energy used today (MWh)': {value: 0, onChange: 53.4},
        }
    }
])
...
<template>
    <div class="flex flex-col justify-center items-center shadow-md p-4 rounded-lg">
